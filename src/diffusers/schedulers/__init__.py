...
try:
    ...
    _import_structure["scheduling_flow_match_euler_ancestral_discrete"] = ["FlowMatchEulerAncestralDiscreteScheduler"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .scheduling_flow_match_euler_ancestral_discrete import FlowMatchEulerAncestralDiscreteScheduler
